const missions = [
  {
    "question": "What is wrong with this token lifecycle?",
    "snippet": "code1 valid + code2 valid + code3 valid",
    "choices": [
      "Old codes stay active",
      "HTTPS is enabled",
      "DNS is cached",
      "UI is responsive"
    ],
    "answer": "Old codes stay active",
    "hint": "Only the newest code should normally work."
  },
  {
    "question": "What should resend do?",
    "snippet": "resend_verification_code(user)",
    "choices": [
      "Invalidate previous codes",
      "Publish all codes",
      "Disable login forever",
      "Return database secrets"
    ],
    "answer": "Invalidate previous codes",
    "hint": "New code should replace old code."
  },
  {
    "question": "Which control reduces abuse?",
    "snippet": "many code requests in short time",
    "choices": [
    ...
    "answer": "Rate-limit resend attempts",
    "hint": "Slow down repeated token generation."
  }
];
const flag = "FLAG{NEW_VERIFICATION_CODES_SHOULD_INVALIDATE_OLD_ONES}";
let index = 0;
let score = 0;
let lives = 3;
let answered = false;
